...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == 'update') {
    ...
    if (!empty($contraseña)) {
        ...
        $sql = "UPDATE usuario SET usuario='$usuario', cargo='$cargo', contraseña='$contraseña_hash', email='$email', movil='$movil' WHERE idUser=$id";
    } else {
        $sql = "UPDATE usuario SET usuario='$usuario', cargo='$cargo', email='$email', movil='$movil' WHERE idUser=$id";
    }

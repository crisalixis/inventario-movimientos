...
if ($result_materiales->num_rows > 0) {
    echo "<table>";
    echo "<tr><th>ID Material</th><th>Nombre</th><th>Descripcion</th><th>Categoria</th><th>Cantidad</th><th>Codigo</th><th>Fecha Ingreso</th>";

    while ($row_material = $result_materiales->fetch_assoc()) {
        echo "<tr>";
        echo "<td>" . $row_material['id_material'] . "</td>";
        echo "<td>" . $row_material['nombre'] . "</td>";
        echo "<td>" . $row_material['descripcion'] . "</td>";
        echo "<td>" . $row_material['categoria'] . "</td>";
        echo "<td>" . $row_material['cantidad'] . "</td>";
        echo "<td>" . $row_material['codigo'] . "</td>";
